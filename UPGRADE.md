...
This is the operations-grade upgrade procedure for **JT-GELFLOW v1.5.1+**. Version updates pull from the public GitHub repo.
...
```bash
JT_GELFLOW_BRANCH=v1.5.1 \
  curl -fsSL https://raw.githubusercontent.com/jasoncheng7115/jt-gelflow/v1.5.1/install.sh | sudo bash
```

(Replace `v1.5.1` with the tag of your choice.)
